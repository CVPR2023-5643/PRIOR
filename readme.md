...
This is the implementation of the CVPR2023 paper with id 5643 ***PRIOR: Prototype Representation Joint Learning from Medical Images and Reports.***
...
### Pre-trained weights
We released our pre-trained model on pretrained/prior_resnet50.pt, you can download [here](https://github.com/CVPR2023-5643/PRIOR/blob/main/pretrained/prior_resnet50.pt)
